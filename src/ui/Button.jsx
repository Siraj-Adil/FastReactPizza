...
function Button({ children, disabled, to, type, onClick }) {
    ...
    const styles = {
        ...
        round: base + " px-2.5 py-1.5 md:px-3.5 md:py-2 text-sm",
        secondary:
            "inline-block text-sm rounded-full bg-transparent border-2 border-stone-300 px-4 py-2.5 md:px-6 md:py-3.5 font-semibold tracking-wide text-stone-400 uppercase transition-colors duration-300 hover:bg-stone-300 focus:ring hover:text-stone-800 focus:text-stone-800 focus:ring-stone-200 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed",
    };
